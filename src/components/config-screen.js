        ...
        return(
            <div id="config-panel" className={panelClass}>
                ...
                <div className="panel flex flex-columns centre min">
                    ...
                    <div className="flex flex-rows centre min">
                        <label htmlFor="dynamic-colour-radio">Dynamic</label>
                        <input id="dynamic-colour-radio" type="radio" name="colour-scheme-radio" value="1"/>
                        <label htmlFor="static-colour-radio">Static</label>
                        <input id="static-colour-radio" type="radio" name="colour-scheme-radio" value="2"/>
                    </div> 
                </div>
                <div className="panel flex flex-columns centre min"> 
                    <span>Static Colour</span> 
                    <input type="color" id="static-colour"/>                   
                </div>   
